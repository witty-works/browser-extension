...
const IconController: React.FC<IconControllerProps> = ({
  ...
  const fixedPositionIcon = isGoogleDocs(element);
  ...
  return (
    <div
      ...
      style={{
        ...
        top: fixedPositionIcon
          ? iconPositionGoogleDocs.top
          : `${
              scrollContainerScrollTop +
              (isMicrosoftOnlineExcel(window.location.href) ? 0 : 8)
            }px`, //add padding like this to minimize clickable area
    ...
    >
      ...
      {userIsLoggedIn && iconType == 'warning' && (
        <WarningIcon
          ...
          onClick={() => {
            ...
            maxLengthWarning.style.display =
              maxLengthWarning.style.display == 'block' ? 'none' : 'block';
            maxLengthWarning.style.display == 'block' &&
              analytics.maxCharLengthReachedLog('max_char_length_icon_clicked');
          }}
        />
      )}
      ...
      <div
        id='maxLengthWarning'
        className='witty-works-warning-wrapper'
        style={{
          display: 'none',
          visibility: 'visible',
          position: 'absolute',
      ...
      >
        <div
          className='witty-works-warning-headline-wrapper'
          style={{
            background:
              'linear-gradient(114.59deg, #F06464 1.6%, #F277D0 32.79%, #9489DB 71.64%)',
            height: '2em',
            display: 'flex',
            flexDirection: 'row',
            alignItems: 'center',
        ...
        >
          <div
            className='witty-works-warning-headline'
            style={{
              fontSize: '18px',
              fontWeight: 600,
              color: 'white',
        ...
        <div
          className='witty-works-warning-text'
          style={{
            color: 'black',
            fontSize: '12px',
            padding: '1em',
