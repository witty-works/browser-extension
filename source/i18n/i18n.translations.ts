...
export const de = {
  [namespaces.options]: {
    ...
    genderedRolesFormatHint:
      'Wie soll Witty mit dem generischen Maskulinum in gegenderten Sprachen umgehen?',
    ...
    apiKeyHint:
      'Wird als x-key an die NLP-API gesendet. Ein Dashboard wird nicht benötigt.',
    ...
    orgOverrideNote:
      'Im Konto-Modus können diese Werte von den Vorgaben deiner Organisation überschrieben werden.',
    endpointHeadline: 'Eigener Server',
    endpointIntro:
      'Zeigt Witty auf deine eigene Installation. Nur ändern, wenn du weisst, was du tust.',
    endpointWarning:
      'Achtung: Der eingetragene Server erhält jeden Text, den du in Eingabefeldern schreibst. Trage nur eine Installation ein, der du vertraust.',
    dashboardUrl: 'Dashboard-URL',
    apiUrl: 'NLP-API-URL',
    oauthClientId: 'OAuth Client ID',
    redirectUriHint:
      'Registriere diese Redirect-URI im OAuth-Client deines Dashboards:',
    ...
    signOutNotice:
      'Beim Wechsel des Servers wirst du abgemeldet: Tokens gelten immer nur für einen Server.',
  ...
  [namespaces.popover]: {
    ...
    suggestionsDialog: 'Witty Vorschläge',
  ...
  [namespaces.iconController]: {
    ...
    totalMaxCharLengthReachedNotificationText:
      'Witty prüft {{limit}} Zeichen auf einmal. Dein Text hat {{total}} Zeichen — markiere weitere Abschnitte, um sie zu prüfen.',
  },
...
export const en = {
  [namespaces.options]: {
    ...
    genderedRolesFormatHint:
      'How should Witty handle the generic masculine in gendered languages like German or French?',
    ...
    orgOverrideNote:
      'In account mode your organisation settings may override these.',
    endpointHeadline: 'Custom server',
    endpointIntro:
      'Point Witty at your own deployment. Only change this if you know what you are doing.',
    endpointWarning:
      'Warning: the server you enter receives every text you write in input fields. Only enter a deployment you trust.',
    dashboardUrl: 'Dashboard URL',
    apiUrl: 'NLP API URL',
    oauthClientId: 'OAuth client ID',
    redirectUriHint:
      'Register this redirect URI on your dashboard OAuth client:',
    ...
    signOutNotice:
      'Changing server signs you out: tokens are only ever valid for one server.',
  ...
  [namespaces.popover]: {
    ...
    close: 'Close Witty',
    suggestionsDialog: 'Witty suggestions',
    removeText: 'Remove:',
  ...
  [namespaces.iconController]: {
    ...
    totalMaxCharLengthReachedNotificationText:
      'Witty checks {{limit}} characters at a time. Your text has {{total}} characters — select further sections to check them.',
  },
  [namespaces.notifications]: {
    pinNotificationHeadline: 'Pin Witty',
...
export const fr = {
  [namespaces.options]: {
    ...
    genderedRolesFormatHint:
      'Comment Witty doit-il traiter le masculin générique dans les langues genrées ?',
    ...
    apiKey: 'Clé API',
    apiKeyHint:
      "Envoyée comme x-key à l'API NLP. Aucun tableau de bord requis.",
    ...
    categoriesIntro:
      'Les catégories désactivées ne sont plus mises en évidence.',
    orgOverrideNote:
      'En mode compte, les paramètres de votre organisation peuvent les remplacer.',
    endpointHeadline: 'Serveur personnalisé',
    endpointIntro:
      'Pointez Witty vers votre propre installation. Ne modifiez ceci que si vous savez ce que vous faites.',
    endpointWarning:
      "Attention : le serveur indiqué reçoit tout texte que vous saisissez dans les champs. N'indiquez qu'une installation de confiance.",
    dashboardUrl: 'URL du tableau de bord',
    apiUrl: "URL de l'API NLP",
    oauthClientId: 'ID client OAuth',
    redirectUriHint:
      'Enregistrez cette URI de redirection sur le client OAuth de votre tableau de bord :',
    save: 'Enregistrer et se déconnecter',
    reset: 'Réinitialiser',
    saved:
      'Enregistré. Vous avez été déconnecté·e — veuillez vous reconnecter.',
    ...
    signOutNotice:
      'Changer de serveur vous déconnecte : les jetons ne sont valables que pour un seul serveur.',
  ...
  [namespaces.popover]: {
    ...
    close: 'Fermer Witty',
    suggestionsDialog: 'Suggestions Witty',
  ...
  [namespaces.iconController]: {
    ...
    totalMaxCharLengthReachedNotificationText:
      "Witty vérifie {{limit}} caractères à la fois. Votre texte compte {{total}} caractères — sélectionnez d'autres sections pour les vérifier.",
  },
  [namespaces.notifications]: {
