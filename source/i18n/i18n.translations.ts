...
export const de = {
  [namespaces.options]: {
    ...
    genderedRolesFormatHint: "Wie soll Witty mit dem generischen Maskulinum in gegenderten Sprachen umgehen?",
    germanGenderEnding: "Deutsche Gender-Endung",
    germanGenderEndingHint: "Witty empfiehlt den Gendestern.",
    frenchGenderSeparator: "Französisches Gender-Trennzeichen",
    frenchGenderSeparatorHint: "Witty empfiehlt den Point médian.",
    roles_none: "Nur geschlechtsneutrale Alternativen vorschlagen",
    roles_both: "Das gewählte Gender-Trennzeichen und die weibliche und männliche Form vorschlagen",
    roles_inclusive_gender: "Gewählte Gender-Trennzeichen vorschlagen",
    roles_binary_gender: "Weibliche und männliche Form vorschlagen",
    useApiDefault: "Standard des Servers",
    levelOff: "Aus",
    levelBasic: "Basis",
    levelAdvanced: "Erweitert",
    levelLocked: "Immer aktiv",
    categoriesFailed: "Kategorien konnten nicht geladen werden.",
...
export const en = {
  [namespaces.options]: {
    ...
    genderedRolesFormatHint: "How should Witty handle the generic masculine in gendered languages like German or French?",
    germanGenderEnding: "German gender ending",
    germanGenderEndingHint: "Witty recommends the genderstar.",
    frenchGenderSeparator: "French gender separator",
    frenchGenderSeparatorHint: "Witty recommends the point médian.",
    roles_none: "Suggest only gender-neutral alternatives",
    roles_both: "Suggest both the chosen gender separator and the female and male form",
    roles_inclusive_gender: "Suggest the chosen gender separator",
    roles_binary_gender: "Suggest the female and male form",
    useApiDefault: "Server default",
    levelOff: "Off",
    levelBasic: "Basic",
    levelAdvanced: "Advanced",
    levelLocked: "Always on",
    categoriesFailed: "Could not load categories.",
...
export const fr = {
  [namespaces.options]: {
    ...
    genderedRolesFormatHint: "Comment Witty doit-il traiter le masculin générique dans les langues genrées ?",
    germanGenderEnding: "Terminaison de genre allemande",
    germanGenderEndingHint: "Witty recommande le genderstar.",
    frenchGenderSeparator: "Séparateur de genre français",
    frenchGenderSeparatorHint: "Witty recommande le point médian.",
    roles_none: "Proposer uniquement des alternatives non genrées",
    roles_both: "Suggérer le séparateur de genre choisi ainsi que les formes féminines et masculines",
    roles_inclusive_gender: "Suggérer le séparateur de genre choisi",
    roles_binary_gender: "Proposer le masculin et le féminin",
    useApiDefault: "Valeur par défaut du serveur",
    levelOff: "Désactivé",
    levelBasic: "Base",
    levelAdvanced: "Avancé",
    levelLocked: "Toujours actif",
