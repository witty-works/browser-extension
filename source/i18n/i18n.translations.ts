...
export const de = {
  ...
  [namespaces.popover]: {
    ...
    copyLink: 'Link kopieren',
    copiedConfirmation: 'URL Kopiert',
    upgradeToTeams: 'Upgrade to Teams DE',
    missingOut: 'You are missing out DE',
    upgradeFor: 'Upgrade for DE',
    inclusiveBulletPointOne: 'Why this term is biased DE',
    inclusiveBulletPointTwo: 'inclusive alternatives for this term DE',
