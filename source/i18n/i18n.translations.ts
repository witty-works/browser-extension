...
export const de = {
  ...
  [namespaces.pages.popup]: {
    ...
    doesWittyWorkExplanation:
      'Du befindest dich auf einer Website, von der wir nicht wissen, ob Witty funktioniert. Wir arbeiten hart daran, dass Witty auf allen Seiten funktioniert, aber manchmal ist Witty noch nicht schlau genug. 🤷‍♀️',
    fillInSurvey: 'Bitte fülle diese Umfrage aus, um uns zu helfen.',
    ...
    resultSurveyNegative:
      'NEIN, Witty funktioniert nicht korrekt! Wir deaktivieren Witty auf dieser Website, bis wir Witty auch hier zum Laufen bringen.',
    finishSurvey: 'Umfrage beenden',
    tryAgain: 'Nochmals versuchen',
    understood: 'Verstanden',
    websiteSettingsDeactivated:
      'Du hast uns bereits mitgeteilt, dass Witty auf {{Domain}} nicht funktioniert.',
    tryAgainOnThisWebsite: 'Propiere Witty erneut auf dieser Website.',
    lockedInfo: 'Diese Funktion wird von deiner*m Team-Admin gesetzt.',
...
export const en = {
  ...
  [namespaces.pages.popup]: {
    ...
    loginToUnlock: 'Log in to unlock features.',
