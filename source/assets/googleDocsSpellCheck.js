...
CanvasRenderingContext2D.prototype.lineTo = function (t, s) {
    if (!this.strokeStyle || wittyIsDisabled() || !GDOCS_LINE_COLORS.includes(this.strokeStyle.toLowerCase())) {
...
CanvasRenderingContext2D.prototype.fillRect = function (t, e, n, r) {
    if (!this.fillStyle || wittyIsDisabled() || !GDOCS_RECT_COLORS.includes(this.fillStyle.toLowerCase())) return fillRectPrototype.apply(this, arguments)
};
